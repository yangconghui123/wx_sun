...
Page({
    ...
    loadData: function(t) {
        ...
        if ("" == a.data.cat_list || 5 != e.cat_style && 4 != e.cat_style && 2 != e.cat_style&& 6 != e.cat_style) {
            ...
            o && a.setData({
                ...
                success: function(t) {
                    ...
                    }), 4 !== e.cat_style && 2 !== e.cat_style&& 6 !== e.cat_style || a.catItemClick({
                        currentTarget: {
                            dataset: {
                                index: 0
                            }
    ...
    catItemClick: function(t) {
        ...
        var cat_id = this.data.cat_list[a].id;
        this.list(cat_id, 1)
    },
    firstcat: function(t) {
