...
Page({
    ...
    onLoad: function(e) {
        ...
        getApp().core.showLoading({
            ...
            success: function(t) {
                getApp().core.hideLoading(), 1 != t.code ? (0 == t.code && (a.setData({
                    ...
                    is_finish: t.data.hongbao.is_finish,
                    is_expire: t.data.hongbao.is_expire,
      ...
      var resolution =  setInterval(function () {
        // console.log(e.id)
        // debugger;
        getApp().request({
          url: getApp().api.fxhb.leave_num,
          method: "get",
          data: {
            id:e.id
          },
          success: function (e) {
            if (e.code==0){
              ...
              if (e.num == 0) {
                var money = e.fxhb.coupon_money;
                var use_minimum = e.fxhb.coupon_use_minimum;
                var my_coupon = {
                  money: money,
            ...
            //     if (a.data.setswitch == false && a.data.is_my_hongbao == true){
            //   wx.showModal({
            //     title: '红包提示',
            //     content: '恭喜您，已成功瓜分',
            //     showCancel: false,
