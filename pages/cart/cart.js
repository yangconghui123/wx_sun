Page({
  ...
  drawStart: function (e) {
    ...
    for (var index in this.data.cart_list) {
      var item = this.data.cart_list[index]
      item.right = 0
    }
    this.setData({
  ...
  drawMove: function (e) {
    var touch = e.touches[0]
    var item = this.data.cart_list[e.currentTarget.dataset.index]
  ...
  delItem: function (e) {
    ...
    // console.log(e.target.dataset.item.goods_id);
    // console.log(e.target.dataset.item.cart_id);
    var cart_id = e.target.dataset.item.cart_id;
    var cart_id_list = [];
