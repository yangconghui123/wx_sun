...
Page({
    ...
    bindPickerChange: function(e) {
        ...
        var value =  this.data.orderPay[e.detail.value];
        var a = this, t = a.data.pay_type_list;
        1 == t.length ? (getApp().core.showLoading({
            title: "正在提交",
            mask: !0
        }), 0 == t[0].payment && a.WechatPay(e), 3 == t[0].payment && a.BalancePay(e),4 == t[0].payment && a.BalancePay(e)) : getApp().core.showModal({
            title: "提示",
            content: "确定使用"+value+"？",
            success: function(t) {
                if (t.confirm) {
                    getApp().core.showLoading({
                        title: "正在提交",
                        mask: !0
                    }), index==0||index==2? a.BalancePay(e): a.WechatPay(e);
                  } else if (t.cancel) {
                  }
