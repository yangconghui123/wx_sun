...
var api = {
    ...
    order: {
        ...
        send: _api_root + "order/send",
       cancel: _api_root + "order/cancel",
       order_multi_express: _api_root + "order/order-multi-express",
       part__revoke: _api_root + "order/part-revoke",
    },
    user: {
        ...
        member: _api_root + "user/new-member",
        ...
        submit_member_info: _api_root + "user/submit-member-info",
        memberInfo: _api_root + "user/member-info",
        ...
        apply_level: _api_root + "user/apply-level",
        recharge_log_submit: _api_root + "user/recharge-log-submit",
        credit_index: _api_root + "credit/index",
        credit_record: _api_root + "credit/record",
        salesman_index: _api_root + "salesman/index",
        salesman_order: _api_root + "salesman/order",
        change_nickname: _api_root + "user/change-nickname",
        get_nickname: _api_root + "user/get-nickname",
    },
    share: {
        join: _api_root + "share/join",
        get_bonus: _api_root +'partner/get-bonus',
    ...
    fxhb: {
        ...
        leave_num: _api_root + "fxhb/index/leave-num",
    },
    recharge: {
