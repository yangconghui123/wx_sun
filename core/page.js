module.exports = {
    ...
    myLogin: function(n) {
        ...
        my.getAuthCode({
            ...
            success: function(o) {
                my.getOpenUserInfo({
                    success: function(e) {
                        console.log("myLogin->", n), console.log("getAuthCode->", o), console.log("getOpenUserInfo->", e);
                        var t = JSON.parse(e.response);
                        t.response && t.response.code && "10000" == t.response.code && a.unionLogin({
                            code: o.authCode,
            ...
            success: function(e) {
                if (e.code) {
                    ...
                    getApp().request({
                        ...
                        complete: function(e) {
                           n.setData({
                             user_bind_show: false
                           })
                           wx.setStorageSync("user_bind_show", 'false');
                            getApp().core.hideLoading();
                        }
                    });
                } else getApp().core.showToast({
    ...
    setUserInfoShow: function() {
      ...
      if (wx.getStorageSync("user_bind_show")==""){
        this.currentPage.setData({
          user_bind_show:!0,
        });
        }
      if (wx.getStorageSync("user_bind_show") == false) {
        this.currentPage.setData({
          user_bind_show: false
        });
      }
