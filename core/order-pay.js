    ...
    init: function(l, e) {
        ...
        y || (y = 0), _.page.orderPay = function(e) {
            ...
            p = A.order.pay_data, u = "/pages/order/order"), 3 == r.payment) {
                ...
                var t = getApp().getUser();
                getApp().core.showModal({
                    title: "当前授信额度：" + t.credit_money,
                    content: "是否确定使用授信额度支付",
                    success: function(e) {
                        e.confirm && o();
                    }
                });
                    ...
                    success: function(e) {
                        if (0 == e.code) {
                            ...
                            0 == r.payment ? app.request({
                                        ...
                                        setTimeout(function() {
                                            ...
                                            complete: function(e) {
                                              ...
                                              if ("requestPayment:ok" == e.errMsg){
                                                var src = "qfQvQSSGO9qp8g2zgJ8mCFyrIisSQ-t08BLLsmGZZlo";
                                                ...
                                                //       }
                                                //     }
                                                //     if (res["qfQvQSSGO9qp8g2zgJ8mCFyrIisSQ - t08BLLsmGZZlo"] =="accept"){
                                ...
                                // credit_pay
                            }) : 2 == r.payment ? (a = "HUODAO_PAY", t()): 4 == r.payment ? (a = "CREDIT_PAY", t()) : 3 == r.payment && (a = "BALANCE_PAY", 
                            t());
                        }
